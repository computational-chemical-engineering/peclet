...
- A3. Scratch hygiene. The umbrella working tree carries untracked campaign directories
  (`flow-*` worktrees and a hash-named paper directory; `sphere-cfd-validation/` and `proposal/` moved to
  `~/Codes/` on 2026-09-08, and `.sdf-campaign-probes/` into `flow/tests/study/sdf_campaign/` on 2026-09-22).
